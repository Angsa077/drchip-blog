            ...
            <section className='container mx-auto px-5 py-10'>
                <div className='w-full max-w-sm mx-auto'>
                    ...
                    <form onSubmit={handleSubmit(submitHandler)}>
                        ...
                        <div className='flex flex-col mb-6 w-full'>
                            <label htmlFor="confirmPassword" className='text-[#5a7184] font-semibold block'>Konfirmasi Password</label>
                            <input type="password" id='confirmPassword' placeholder='Masukan konfirmasi password anda' className={`placeholder:[#959ead] text-dark-light mt-3 rounded-lg px-5
                            py-4 font-semibold block outline-none border ${errors.confirmPassword ? "border-red-500" : "border-[#c3cad9]"}`}
