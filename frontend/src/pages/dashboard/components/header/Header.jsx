...
const Header = () => {
    ...
    const [activeNavMenu, setActiveNavName] = useState("dashboard");
    ...
    const { mutate: mutateCreatePost, isLoading: isLoadingCreatePost } =
        useMutation({
            ...
            onSuccess: (data) => {
                ...
                toast.success("Project berhasil dibuat silahkan lengkapi!");
            ...
            {isMenuActive && (
                <div className="fixed inset-0 lg:static lg:h-full lg:w-full">
                    ...
                    <div className="fixed top-0 bottom-0 left-0 z-50 w-3/4 overflow-y-auto bg-white p-4 lg:static lg:h-full lg:w-full lg:p-6">
                        ...
                        <h4 className="mt-10 font-bold text-[#C7C7C7]">Dashboard</h4>
                        {/* menu items */}
                        <div className="mt-6 flex flex-col gap-y-[0.563rem]">
                            ...
                            <NavItemCollapse
                                ...
                                setActiveNavName={setActiveNavName}
                            >
                                <Link to="/dashboard/posts/manage">Kelola project</Link>
                                <button disabled={isLoadingCreatePost} className="text-start disabled:opacity-60 disabled:cursor-not-allowed" onClick={() => handleCreateNewPost({ token: userState.userInfo.token })}>Tambah Project</button>
                            </NavItemCollapse>
